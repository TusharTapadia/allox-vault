...
contract PriceOracle is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
  ...
  function initialize(address _WETH, uint256 _oracleExpirationThreshold) public initializer {
        __Ownable_init();
