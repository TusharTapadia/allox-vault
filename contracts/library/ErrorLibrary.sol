...
library ErrorLibrary {
  ...
  /// @notice Thrown when caller is not vault
  ...
  error TokenNotETH();
  /// @notice Throws when caller is not vault manager
  error CallerNotVaultManager();
  /// @notice Throws when caller is not strategy manager
  error CallerNotStrategyManager();
  /// @notice Throws when zero address is passed
  error ZERO_ADDRESS();
  /// @notice Throws when weight is not valid
  error InvalidWeight();
  /// @notice Throws when protocol is paused
