...
export interface AccessControllerInterface extends utils.Interface {
  functions: {
    ...
    "STRATEGY_MANAGER_ROLE()": FunctionFragment;
    "SUPER_ADMIN_ROLE()": FunctionFragment;
    "VAULT_MANAGER_ROLE()": FunctionFragment;
    ...
    "setupInitialRoles(address,address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setupInitialRoles",
...
export interface AccessController extends BaseContract {
  ...
  functions: {
    ...
    STRATEGY_MANAGER_ROLE(overrides?: CallOverrides): Promise<[string]>;

    SUPER_ADMIN_ROLE(overrides?: CallOverrides): Promise<[string]>;

    VAULT_MANAGER_ROLE(overrides?: CallOverrides): Promise<[string]>;
    ...
    setupInitialRoles(
      ...
      _strategyManagerAddress: string,
  ...
  estimateGas: {
    ...
    STRATEGY_MANAGER_ROLE(overrides?: CallOverrides): Promise<BigNumber>;

    SUPER_ADMIN_ROLE(overrides?: CallOverrides): Promise<BigNumber>;

    VAULT_MANAGER_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
